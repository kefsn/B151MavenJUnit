...
public class NT02_Dropdown {
   /*
    ...
    public void test01() {
        //1.Method:
        //            a. Yil,ay,gün dropdown menu'leri locate ediniz
        WebElement yil = driver.findElement(By.xpath("//select[3]"));
        ...
        select.selectByIndex(5);//İndex 0 dan başlar 2018'i seçer

        Select select1 = new Select(ay);
        select1.selectByValue("6");//Value ile alındı
    ...
    public void test02() {
        ...
        //getOptions() methodu ile tüm seçenekleri yazdık.
    ...
    public void test03() {
        ...
        //a. State dropdownindaki varsayilan secili
        // secenegin 'Select a State' oldugunu verify edelim
        WebElement eyaletler = driver.findElement(By.xpath("(//select)[5]"));
        Select select = new Select(eyaletler);
