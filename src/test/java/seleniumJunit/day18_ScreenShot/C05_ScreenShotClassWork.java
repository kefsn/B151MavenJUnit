...
//Techproeducation sayfasına gidelim
        ...
        tumSayfaResmi();//Methodla tüm sayfanın resmini aldık
        ...
        webElementResmi(sonucYazisi);//Methodla sonuc resmini aldık
        ...
        //ve sonuc yazısının resmini alalım
        WebElement sonucYazisiAmazon = driver.findElement(By.xpath("(//*[@class='sg-col-inner'])[1]"));
