...
public class NT01_WindowHandles extends TestBase {
    @Test
    public void test01() {
    ...
    public void test03() {
        ...
        /*
       Set ve ArrayList kullanmadan switchTo().window() methodu içine argüman olarak
       driver.getWindowHandles() methodu ile bütün açılan pencereleri alıp
       bir array olarak indeks belirterek istediğim pencereye geçiş yapabilirim.
         */
